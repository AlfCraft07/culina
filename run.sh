...
BUILD_PROP "$FIRM_DIR/$TARGET_DEVICE" "system_ext" "ro.build.date.utc" "$(date +%s)"
...
BUILD_PROP "$FIRM_DIR/$TARGET_DEVICE" "system_ext" "ro.build.date" "$(LANG=C date '+%a %b %e %H:%M:%S %Z %Y)"
