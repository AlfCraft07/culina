...
source "$(pwd)/scripts/QuantumRom-wifi.sh"
...
PATCH_MID_BOOT_FLIP "$FIRM_DIR/$TARGET_DEVICE" "$WORK_DIR/services"
PATCH_DEXOPT_DIALOG_FLIP "$FIRM_DIR/$TARGET_DEVICE" "$WORK_DIR/services"
...
BUILD_PROP "$FIRM_DIR/$TARGET_DEVICE" "system" "ro.build.display.id" "${B_ID} ${B_V}-ROManitas"
BUILD_PROP "$FIRM_DIR/$TARGET_DEVICE" "product" "ro.build.display.id" "${B_ID} ${B_V}-ROManitas"
BUILD_PROP "$FIRM_DIR/$TARGET_DEVICE" "system" "ro.build.date.utc" "$(date +%s)"
BUILD_PROP "$FIRM_DIR/$TARGET_DEVICE" "product" "ro.build.date.utc" "$(date +%s)"
BUILD_PROP "$FIRM_DIR/$TARGET_DEVICE" "system" "ro.build.date" "$(LANG=C date '+%a %b %e %H:%M:%S %Z %Y')"
BUILD_PROP "$FIRM_DIR/$TARGET_DEVICE" "product" "ro.build.date" "$(LANG=C date '+%a %b %e %H:%M:%S %Z %Y')"
BUILD_PROP "$FIRM_DIR/$TARGET_DEVICE" "system" "ro.system.build.date.utc" "$(date +%s)"
BUILD_PROP "$FIRM_DIR/$TARGET_DEVICE" "system_ext" "ro.system_ext.build.date.utc" "$(date +%s)"
BUILD_PROP "$FIRM_DIR/$TARGET_DEVICE" "product" "ro.product.build.date.utc" "$(date +%s)"
BUILD_PROP "$FIRM_DIR/$TARGET_DEVICE" "system" "ro.system.build.date" "$(LANG=C date '+%a %b %e %H:%M:%S %Z %Y')"
BUILD_PROP "$FIRM_DIR/$TARGET_DEVICE" "system_ext" "ro.system_ext.build.date" "$(LANG=C date '+%a %b %e %H:%M:%S %Z %Y')"
BUILD_PROP "$FIRM_DIR/$TARGET_DEVICE" "product" "ro.product.build.date" "$(LANG=C date '+%a %b %e %H:%M:%S %Z %Y')"
